  ...
  ```powershell
  & "$env:USERPROFILE\AppData\Local\Programs\Python\Launcher\py.exe" "$env:USERPROFILE\.codex\skills\.system\skill-
  installer\scripts\install-skill-from-github.py" --repo Ban-code-art/backend-interviewer-skill --path . --name backend-
  interviewer
